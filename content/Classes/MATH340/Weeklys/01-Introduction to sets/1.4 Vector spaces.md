...
As seen earlier (please see [[1.1 Sets]]), elements of $\mathbb{R}^n$ are $n$-[[1.1 Sets#1.3 Ordered pairs|tuples]] of the form $(x_1,x_2,...x_n)$ where $x$ components are real numbers. Each on one of these elements if called a vector.
...
## Theorem 1.3 The distance formula
