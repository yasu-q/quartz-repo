![https://www.youtube.com/watch?v=5A39Ht9Wcu0&ab_channel=SerpentineIntegral](https://www.youtube.com/watch?v=5A39Ht9Wcu0&ab_channel=SerpentineIntegral)
...
i.e. ${\bf a}$ is a minimum if every function value $f({\bf x})$ is bigger than $f({\bf a})$ for ${\bf x}$ points around ${\bf a}$
## Theorem 9.3
