...
## 5.1 Multi linearity
Let $D : M_n(\mathbb{R}) \rightarrow \mathbb{R}$ be a function. (the domain is a square $n \times n$ [[2.3 Example subspaces, row, and col spaces#2.6 Matrix|matrix]] of real numbers)
...
or check [this video](https://www.youtube.com/watch?v=H9BWRYJNIv4&ab_channel=KhanAcademy) out.
## 5.2 Determinant
...
![3blue1brown vid](https://www.youtube.com/watch?v=Ip3X9LOh2dk&ab_channel=3Blue1Brown)