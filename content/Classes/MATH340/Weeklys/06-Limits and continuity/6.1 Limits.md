...
$$
Like, all the points at a distance less the $r$, meaning they are 'in' the ball. Note that this is under the standard [[4.1 Norms#4.1 Norm|Euclidean norm]]
### Notes
- $||{\bf x} - {\bf a}|| < 0$ is not possible
...
![https://www.youtube.com/watch?v=kfF40MiS7zA&ab_channel=3Blue1Brown](https://www.youtube.com/watch?v=kfF40MiS7zA&ab_channel=3Blue1Brown)
...
***
## Example 6.2
Prove that $\lim\limits_{x \rightarrow 1} 3x+2 = 5$ 

TF DO YOU MEAN "PROVE"
...
[[4.1 Norms#The triangle inequality|Triangle inequality]] real handy ngl
***
## Theorem 6.1
